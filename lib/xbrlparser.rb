...
class XmlElement
  ...
  def initialize(root_node, parent = nil, document_uri = nil)
    @root = root_node
    @parent = parent
    @document_uri = nil
  end
  ...
  def id
    @id ||= get_qualified_attr(NS_XSD, 'id')
  end
  ...
  def base(document_uri = nil)
    @base ||= if parent
                ...
                base_uri = @root.attribute_with_ns("base", NS_XML) || @document_uri || document_uri
